...
public final class PurchaseUpdatesResponse {
    ...
    public PurchaseUpdatesResponse(String str, String str2, PurchaseUpdatesRequestStatus purchaseUpdatesRequestStatus, Set<Receipt> set, Set<String> set2, Offset offset, boolean z) {
