...
public class Base64 {
    ...
    */
    private static byte[] encode3to4(byte[] r5, int r6, int r7, byte[] r8, int r9, byte[] r10) {
        ...
        L6f:
            ...
            goto L28
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.vending.licensing.util.Base64.encode3to4(byte[], int, int, byte[], int, byte[]):byte[]");
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:38:0x0031, code lost:
        ...
        throw new com.google.android.vending.licensing.util.Base64DecoderException("single trailing character at offset " + (r18 - 1));
     */
    /* JADX WARN: Code restructure failed: missing block: B:39:0x00d9, code lost:
    
        r2 = r3 + 1;
        r1[r3] = com.google.android.vending.licensing.util.Base64.EQUALS_SIGN;
    ...
    */
    public static byte[] decode(byte[] r16, int r17, int r18, byte[] r19) throws com.google.android.vending.licensing.util.Base64DecoderException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.vending.licensing.util.Base64.decode(byte[], int, int, byte[]):byte[]");
    }
}
