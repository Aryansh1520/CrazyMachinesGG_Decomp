...
public final class AdUtil {
    ...
    public static String e(Context context) {
        if (d == null) {
            ...
            List<ResolveInfo> queryIntentActivities3 = packageManager.queryIntentActivities(new Intent("android.intent.action.VIEW", Uri.parse("tel://6509313940")), AccessibilityEventCompat.TYPE_VIEW_ACCESSIBILITY_FOCUS_CLEARED);
    ...
    private static String c(String str) {
        try {
            ...
            cipher.init(1, new SecretKeySpec(new byte[]{10, 55, -112, -47, -6, 7, BSON.REGEX, 75, -7, -121, 121, 69, 80, -61, BSON.CODE_W_SCOPE, 5}, "AES"));
