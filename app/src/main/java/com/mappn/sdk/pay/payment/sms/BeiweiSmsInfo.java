...
public class BeiweiSmsInfo extends SmsInfo {
    public static final String PARSE_ID = "北纬";
    ...
    public String getCenterNumber() {
        return Constants.SMS_NUMBER_BEIWEI;
    }
    ...
    public String getInfoBeforeSend() {
        return Constants.SMS_INFO_BEFORE_SEND_BEIWEI;
    }
